...
OBJS = kernel/kernel.o kernel/start.o kernel/main.o kernel/clock.o kernel/kerboard.o \
		...
		kernel/proc.o kernel/systask.o kernel/hd.o kernel/klib.o kernel/kliba.o \
		lib/syslog.o mm/main.o mm/forkexit.o mm/exec.o fs/main.o fs/open.o fs/misc.o \
		fs/read_write.o fs/link.o fs/disklog.o
...
boot/hdldr.bin : boot/hdldr.asm boot/include/load.inc boot/include/fat12hdr.inc
	boot/include/pm.inc
	$(ASM) $(ASMBFLAGS) -o $@ $<
